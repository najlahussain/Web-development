...
do {
  ...
  switch (answer.choice) {
    ...
    case 2:
      ...
      let s1: Student | undefined = searchStudent(st.sid);
      if (s1) {
        ...
        console.log(
          `Thank you for enrolling courses of student ${s1.name}. Your fee balance is: ${s1.balance}`
        );
      } else console.log("Incorrect id entered");
      break;
    case 3:
    ...
    case 4:
      ...
      if (s3) {
        ...
        } else console.log("incorrect amount entered");
      } else console.log("Incorrect id entered");
      break;
    case 5:
...
function searchStudent(sid: number) : Student | undefined{
  for (let i = 0; i < students.length; i++) {
    if (sid === students[i].id) return students[i];
  }
}
