//declaring unions
let myName : string | null = "Najla";
let myAge : number | string | null = 10;
//myName = null;
...
type rawData = string | number; //define your own type

let data : rawData;

let anyVariable : any; //you can use any type with it

function calculate(amount : string | number){
